...
├── README.md                             # This file
└── references/
    ├── CHANGELOG_PATTERNS.md             # Semantic analysis patterns
...
2. Perform semantic analysis using `references/CHANGELOG_PATTERNS.md`
...
- **v2.0** (2026-03-09): Added runtime-level risk analysis
  ...
  - Updated: CHANGELOG_PATTERNS.md with runtime keywords
